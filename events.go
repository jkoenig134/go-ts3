...
const (
	ReasonUserMovedIndependent ReasonId = 0
	ReasonUserWasMoved         ReasonId = 1
	ReasonTimeout              ReasonId = 3
	ReasonChannelKick          ReasonId = 4
	ReasonServerKick           ReasonId = 5
	ReasonServerBan            ReasonId = 6
	ReasonServerLeft           ReasonId = 8
	ReasonServerChannelEdited  ReasonId = 10
...
type ClientEnterViewEvent struct {
	...
	ReasonId                             ReasonId `schema:"reasonid"`
